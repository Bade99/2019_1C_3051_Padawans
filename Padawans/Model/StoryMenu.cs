...
namespace TGC.Group.Model
{
    class StoryMenu : IMenu
    {
        ...
        public StoryMenu(Microsoft.DirectX.DirectInput.Key mappedKey, Microsoft.DirectX.DirectInput.Key skipKey) {
            ...
            texto1.Position = new TGCVector2(D3DDevice.Instance.Width * .1f, D3DDevice.Instance.Height * .2f);
            texto2.Position = new TGCVector2(D3DDevice.Instance.Width * .7f, D3DDevice.Instance.Height * .5f);
            texto3.Position = new TGCVector2(D3DDevice.Instance.Width * .3f, D3DDevice.Instance.Height * .8f);
            texto_skip.Position = new TGCVector2(D3DDevice.Instance.Width * .9f, D3DDevice.Instance.Height * .9f);
            ...
            texto_skip.Scaling = CommonHelper.CalculateRelativeScaling(skip, .01f);
            texto1.Bitmap = b1;
            texto2.Bitmap = b2;
            texto3.Bitmap = b3;
