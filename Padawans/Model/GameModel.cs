    ...
    public class GameModel : TgcExample
    {
        ...
        public override void Init()
        {
            ...
            */
            ...
            cues = new CueManager(new Cue(new DelayCueLauncher(3),"Bitmaps\\WASD.png", .3f, cues_relative_posicion, 1,3, "Sonidos\\obi_wan_luke.wav",.5f,0),
                                  new Cue(new DelayCueLauncher(3),"Bitmaps\\Pause.png", .3f, cues_relative_posicion, 2,3, "Sonidos\\obi_wan_luke.wav",.5f,0)
                                  );
